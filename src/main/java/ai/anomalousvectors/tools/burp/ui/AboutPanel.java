...
public class AboutPanel extends JPanel {
    ...
    public AboutPanel() {
        ...
        JPanel content = buildContent(Version.get());
    ...
    private static JPanel buildContent(String version) {
        ...
        JTextArea area = new JTextArea("""
                This Burp Suite extension exposes a small local HTTP API so external tools can create \
                Collaborator payloads and poll interactions without driving the Burp UI.
                """);
        ...
        panel.add(buildLinkRow("  " + ProductInfo.REPOSITORY_LABEL, ProductInfo.REPOSITORY_URL), "growx");
        return panel;
    }
